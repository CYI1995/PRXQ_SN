...
print(klist)
RM_list1 = np.load('Ratiolist_RM3_d8e01.npy')
RM_list2 = np.load('Ratiolist_RM5_d8e01.npy')
RM_list3 = np.load('Ratiolist_RM7_d8e01.npy')
RM_list4 = np.load('Ratiolist_RM9_d8e01.npy')
RM_list5 = np.load('Ratiolist_RM3_d16e01.npy')
RM_list6 = np.load('Ratiolist_RM5_d16e01.npy')
RM_list7 = np.load('Ratiolist_RM7_d16e01.npy')
RM_list8 = np.load('Ratiolist_RM9_d16e01.npy')
CM_list1 = np.load('Ratiolist_CM_d8e01.npy')
CM_list2 = np.load('Ratiolist_CM_d16e01.npy')
...
plt.savefig('FIG9.pdf', bbox_inches='tight', pad_inches=0.02, dpi=600)
plt.show()