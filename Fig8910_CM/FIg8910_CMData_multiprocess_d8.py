...
if __name__ == '__main__':
    ...
    RandomVecs = np.load('RandomVectors_d8.npy')

    # Prepare arguments for the worker pool
    tasks = [(RandomVecs[n], basis, klist, d) for n in range(Samples)]
    ...
    np.save('Ratiolist_CM_d8e0.npy', Ratiolist_CM0)
    np.save('Ratiolist_CM_d8e01.npy', Ratiolist_CM1)
    np.save('Ratiolist_CM_d8e05.npy', Ratiolist_CM2)
