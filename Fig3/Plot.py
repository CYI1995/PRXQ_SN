...
plt.plot(klist, Ratiolist_CM_eps0,  '--', label=r'$\boldsymbol{\varepsilon = 0}$',   c='royalblue',      marker='o')
plt.plot(klist, Ratiolist_RM_eps0,           c='royalblue',      marker='o')
plt.plot(klist, Ratiolist_CM_eps01, '--', label=r'$\boldsymbol{\varepsilon = 0.1}$', c='orange', marker='s')
plt.plot(klist, Ratiolist_RM_eps01,          c='orange', marker='s')
plt.plot(klist, Ratiolist_CM_eps05, '--', label=r'$\boldsymbol{\varepsilon = 0.5}$', c='g',      marker='^')
